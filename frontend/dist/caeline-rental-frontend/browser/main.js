...
var routes = [
  ...
  {
    path: "",
    loadComponent: () => import("./chunk-VHFYSI4K.js").then((m) => m.HomeComponent)
  },
  {
    path: "packages",
    loadComponent: () => import("./chunk-OVCR3F2D.js").then((m) => m.PackagesComponent)
  },
  {
    path: "catalog",
    loadComponent: () => import("./chunk-UU2BXQMG.js").then((m) => m.CatalogComponent)
  },
  {
    path: "booking",
    loadComponent: () => import("./chunk-Z7XKVSYB.js").then((m) => m.BookingComponent)
  },
  {
    path: "booking/payment-result",
    loadComponent: () => import("./chunk-JCAZ27I6.js").then((m) => m.BookingResultComponent)
  },
  // Admin routes
  {
    path: "admin/login",
    loadComponent: () => import("./chunk-5UHFXCZB.js").then((m) => m.AdminLoginComponent)
  },
  {
    path: "admin",
    loadComponent: () => import("./chunk-T4GATTTP.js").then((m) => m.AdminShellComponent),
    canActivate: [authGuard],
    children: [
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-AILSOESW.js").then((m) => m.DashboardComponent)
      },
      {
        path: "outfits",
        loadComponent: () => import("./chunk-SEGPSTEZ.js").then((m) => m.AdminOutfitsComponent)
      },
      {
        path: "packages",
        loadComponent: () => import("./chunk-HSRPZIZG.js").then((m) => m.AdminPackagesComponent)
      },
      {
        path: "bookings",
        loadComponent: () => import("./chunk-UOOM74MY.js").then((m) => m.AdminBookingsComponent)
      },
      {
        path: "content",
        loadComponent: () => import("./chunk-6HHDF5N5.js").then((m) => m.AdminContentComponent)
      },
      {
        path: "slots",
        loadComponent: () => import("./chunk-VJJNMM4F.js").then((m) => m.AdminSlotsComponent)
      }
    ]
  },
  { path: "**", redirectTo: "" }
